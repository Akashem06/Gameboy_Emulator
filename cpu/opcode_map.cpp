...
void OpcodeHandler::opcode_12() {
  opcode_ld(cpu->de.get(), cpu->af.get_hi_ref());
}
void OpcodeHandler::opcode_13() {
  opcode_inc(cpu->de);
}
void OpcodeHandler::opcode_14() {
  opcode_inc(cpu->de.get_hi_ref());
}
void OpcodeHandler::opcode_15() {
  opcode_dec(cpu->de.get_hi_ref());
}
void OpcodeHandler::opcode_16() {
  opcode_ld(cpu->de.get_hi_ref());
}
...
void OpcodeHandler::opcode_19() {
  opcode_add_hl(cpu->de);
}
void OpcodeHandler::opcode_1A() {
  opcode_ld(cpu->af.get_hi_ref(), cpu->de.get());
}
void OpcodeHandler::opcode_1B() {
  opcode_dec(cpu->de);
}
void OpcodeHandler::opcode_1C() {
  opcode_inc(cpu->de.get_lo_ref());
}
void OpcodeHandler::opcode_1D() {
  opcode_dec(cpu->de.get_lo_ref());
}
void OpcodeHandler::opcode_1E() {
  opcode_ld(cpu->de.get_lo_ref());
}
...
void OpcodeHandler::opcode_22() {
  opcode_ldi(cpu->hl.get(), cpu->af.get_hi_ref());
}
void OpcodeHandler::opcode_23() {
  opcode_inc(cpu->hl);
}
void OpcodeHandler::opcode_24() {
  opcode_inc(cpu->hl.get_hi_ref());
}
void OpcodeHandler::opcode_25() {
  opcode_dec(cpu->hl.get_hi_ref());
}
void OpcodeHandler::opcode_26() {
  opcode_ld(cpu->hl.get_hi_ref());
}
...
void OpcodeHandler::opcode_29() {
  opcode_add_hl(cpu->hl);
}
void OpcodeHandler::opcode_2A() {
  opcode_ldi(cpu->af.get_hi_ref(), cpu->hl.get());
}
void OpcodeHandler::opcode_2B() {
  opcode_dec(cpu->hl);
}
void OpcodeHandler::opcode_2C() {
  opcode_inc(cpu->hl.get_lo_ref());
}
void OpcodeHandler::opcode_2D() {
  opcode_dec(cpu->hl.get_lo_ref());
}
void OpcodeHandler::opcode_2E() {
  opcode_ld(cpu->hl.get_lo_ref());
}
...
void OpcodeHandler::opcode_31() {
  opcode_ld(cpu->sp.get());
}
void OpcodeHandler::opcode_32() {
  opcode_ldd(cpu->hl.get(), cpu->af.get_hi_ref());
}
void OpcodeHandler::opcode_33() {
  opcode_inc(cpu->sp.get());
}
void OpcodeHandler::opcode_34() {
  opcode_inc(cpu->hl.get());
}
void OpcodeHandler::opcode_35() {
  opcode_dec(cpu->hl.get());
}
void OpcodeHandler::opcode_36() {
  opcode_ld(cpu->hl.get());
}
...
void OpcodeHandler::opcode_39() {
  opcode_add_hl(cpu->sp);
}
void OpcodeHandler::opcode_3A() {
  opcode_ldd(cpu->af.get_hi_ref(), cpu->hl.get());
}
void OpcodeHandler::opcode_3B() {
  opcode_dec(cpu->sp.get());
}
void OpcodeHandler::opcode_3C() {
  opcode_inc(cpu->af.get_hi_ref());
}
void OpcodeHandler::opcode_3D() {
  opcode_dec(cpu->af.get_hi_ref());
}
void OpcodeHandler::opcode_3E() {
  opcode_ld(cpu->af.get_hi_ref());
}
void OpcodeHandler::opcode_3F() {
  opcode_ccf();
}
void OpcodeHandler::opcode_40() {
  opcode_ld(cpu->bc.get_hi_ref(), cpu->bc.get_hi_ref());
}
void OpcodeHandler::opcode_41() {
  opcode_ld(cpu->bc.get_hi_ref(), cpu->bc.get_lo_ref());
}
void OpcodeHandler::opcode_42() {
  opcode_ld(cpu->bc.get_hi_ref(), cpu->de.get_hi_ref());
}
void OpcodeHandler::opcode_43() {
  opcode_ld(cpu->bc.get_hi_ref(), cpu->de.get_lo_ref());
}
void OpcodeHandler::opcode_44() {
  opcode_ld(cpu->bc.get_hi_ref(), cpu->hl.get_hi_ref());
}
void OpcodeHandler::opcode_45() {
  opcode_ld(cpu->bc.get_hi_ref(), cpu->hl.get_lo_ref());
}
void OpcodeHandler::opcode_46() {
  opcode_ld(cpu->bc.get_hi_ref(), cpu->hl.get());
}
void OpcodeHandler::opcode_47() {
  opcode_ld(cpu->bc.get_hi_ref(), cpu->af.get_hi_ref());
}
void OpcodeHandler::opcode_48() {
  opcode_ld(cpu->bc.get_lo_ref(), cpu->bc.get_hi_ref());
}
void OpcodeHandler::opcode_49() {
  opcode_ld(cpu->bc.get_lo_ref(), cpu->bc.get_lo_ref());
}
void OpcodeHandler::opcode_4A() {
  opcode_ld(cpu->bc.get_lo_ref(), cpu->de.get_hi_ref());
}
void OpcodeHandler::opcode_4B() {
  opcode_ld(cpu->bc.get_lo_ref(), cpu->de.get_lo_ref());
}
void OpcodeHandler::opcode_4C() {
  opcode_ld(cpu->bc.get_lo_ref(), cpu->hl.get_hi_ref());
}
void OpcodeHandler::opcode_4D() {
  opcode_ld(cpu->bc.get_lo_ref(), cpu->hl.get_lo_ref());
}
void OpcodeHandler::opcode_4E() {
  opcode_ld(cpu->bc.get_lo_ref(), cpu->hl.get());
}
void OpcodeHandler::opcode_4F() {
  opcode_ld(cpu->bc.get_lo_ref(), cpu->af.get_hi_ref());
}
void OpcodeHandler::opcode_50() {
  opcode_ld(cpu->de.get_hi_ref(), cpu->bc.get_hi_ref());
}
void OpcodeHandler::opcode_51() {
  opcode_ld(cpu->de.get_hi_ref(), cpu->bc.get_lo_ref());
}
void OpcodeHandler::opcode_52() {
  opcode_ld(cpu->de.get_hi_ref(), cpu->de.get_hi_ref());
}
void OpcodeHandler::opcode_53() {
  opcode_ld(cpu->de.get_hi_ref(), cpu->de.get_lo_ref());
}
void OpcodeHandler::opcode_54() {
  opcode_ld(cpu->de.get_hi_ref(), cpu->hl.get_hi_ref());
}
void OpcodeHandler::opcode_55() {
  opcode_ld(cpu->de.get_hi_ref(), cpu->hl.get_lo_ref());
}
void OpcodeHandler::opcode_56() {
  opcode_ld(cpu->de.get_hi_ref(), cpu->hl.get());
}
void OpcodeHandler::opcode_57() {
  opcode_ld(cpu->de.get_hi_ref(), cpu->af.get_hi_ref());
}
void OpcodeHandler::opcode_58() {
  opcode_ld(cpu->de.get_lo_ref(), cpu->bc.get_hi_ref());
}
void OpcodeHandler::opcode_59() {
  opcode_ld(cpu->de.get_lo_ref(), cpu->bc.get_lo_ref());
}
void OpcodeHandler::opcode_5A() {
  opcode_ld(cpu->de.get_lo_ref(), cpu->de.get_hi_ref());
}
void OpcodeHandler::opcode_5B() {
  opcode_ld(cpu->de.get_lo_ref(), cpu->de.get_lo_ref());
}
void OpcodeHandler::opcode_5C() {
  opcode_ld(cpu->de.get_lo_ref(), cpu->hl.get_hi_ref());
}
void OpcodeHandler::opcode_5D() {
  opcode_ld(cpu->de.get_lo_ref(), cpu->hl.get_lo_ref());
}
void OpcodeHandler::opcode_5E() {
  opcode_ld(cpu->de.get_lo_ref(), cpu->hl.get());
}
void OpcodeHandler::opcode_5F() {
  opcode_ld(cpu->de.get_lo_ref(), cpu->af.get_hi_ref());
}
void OpcodeHandler::opcode_60() {
  opcode_ld(cpu->hl.get_hi_ref(), cpu->bc.get_hi_ref());
}
void OpcodeHandler::opcode_61() {
  opcode_ld(cpu->hl.get_hi_ref(), cpu->bc.get_lo_ref());
}
void OpcodeHandler::opcode_62() {
  opcode_ld(cpu->hl.get_hi_ref(), cpu->de.get_hi_ref());
}
void OpcodeHandler::opcode_63() {
  opcode_ld(cpu->hl.get_hi_ref(), cpu->de.get_lo_ref());
}
void OpcodeHandler::opcode_64() {
  opcode_ld(cpu->hl.get_hi_ref(), cpu->hl.get_hi_ref());
}
void OpcodeHandler::opcode_65() {
  opcode_ld(cpu->hl.get_hi_ref(), cpu->hl.get_lo_ref());
}
void OpcodeHandler::opcode_66() {
  opcode_ld(cpu->hl.get_hi_ref(), cpu->hl.get());
}
void OpcodeHandler::opcode_67() {
  opcode_ld(cpu->hl.get_hi_ref(), cpu->af.get_hi_ref());
}
void OpcodeHandler::opcode_68() {
  opcode_ld(cpu->hl.get_lo_ref(), cpu->bc.get_hi_ref());
}
void OpcodeHandler::opcode_69() {
  opcode_ld(cpu->hl.get_lo_ref(), cpu->bc.get_lo_ref());
}
void OpcodeHandler::opcode_6A() {
  opcode_ld(cpu->hl.get_lo_ref(), cpu->de.get_hi_ref());
}
void OpcodeHandler::opcode_6B() {
  opcode_ld(cpu->hl.get_lo_ref(), cpu->de.get_lo_ref());
}
void OpcodeHandler::opcode_6C() {
  opcode_ld(cpu->hl.get_lo_ref(), cpu->hl.get_hi_ref());
}
void OpcodeHandler::opcode_6D() {
  opcode_ld(cpu->hl.get_lo_ref(), cpu->hl.get_lo_ref());
}
void OpcodeHandler::opcode_6E() {
  opcode_ld(cpu->hl.get_lo_ref(), cpu->hl.get());
}
void OpcodeHandler::opcode_6F() {
  opcode_ld(cpu->hl.get_lo_ref(), cpu->af.get_hi_ref());
}
void OpcodeHandler::opcode_70() {
  opcode_ld(cpu->hl.get(), cpu->bc.get_hi_ref());
}
void OpcodeHandler::opcode_71() {
  opcode_ld(cpu->hl.get(), cpu->bc.get_lo_ref());
}
void OpcodeHandler::opcode_72() {
  opcode_ld(cpu->hl.get(), cpu->de.get_hi_ref());
}
void OpcodeHandler::opcode_73() {
  opcode_ld(cpu->hl.get(), cpu->de.get_lo_ref());
}
void OpcodeHandler::opcode_74() {
  opcode_ld(cpu->hl.get(), cpu->hl.get_hi_ref());
}
void OpcodeHandler::opcode_75() {
  opcode_ld(cpu->hl.get(), cpu->hl.get_lo_ref());
}
void OpcodeHandler::opcode_76() {
  opcode_halt();
}
void OpcodeHandler::opcode_77() {
  opcode_ld(cpu->hl.get(), cpu->af.get_hi_ref());
}
void OpcodeHandler::opcode_78() {
  opcode_ld(cpu->af.get_hi_ref(), cpu->bc.get_hi_ref());
}
void OpcodeHandler::opcode_79() {
  opcode_ld(cpu->af.get_hi_ref(), cpu->bc.get_lo_ref());
}
void OpcodeHandler::opcode_7A() {
  opcode_ld(cpu->af.get_hi_ref(), cpu->de.get_hi_ref());
}
void OpcodeHandler::opcode_7B() {
  opcode_ld(cpu->af.get_hi_ref(), cpu->de.get_lo_ref());
}
void OpcodeHandler::opcode_7C() {
  opcode_ld(cpu->af.get_hi_ref(), cpu->hl.get_hi_ref());
}
void OpcodeHandler::opcode_7D() {
  opcode_ld(cpu->af.get_hi_ref(), cpu->hl.get_lo_ref());
}
void OpcodeHandler::opcode_7E() {
  opcode_ld(cpu->af.get_hi_ref(), cpu->hl.get());
}
void OpcodeHandler::opcode_7F() {
  opcode_ld(cpu->af.get_hi_ref(), cpu->af.get_hi_ref());
}
void OpcodeHandler::opcode_80() {
  opcode_add_a(cpu->bc.get_hi_ref());
}
void OpcodeHandler::opcode_81() {
  opcode_add_a(cpu->bc.get_lo_ref());
}
void OpcodeHandler::opcode_82() {
  opcode_add_a(cpu->de.get_hi_ref());
}
void OpcodeHandler::opcode_83() {
  opcode_add_a(cpu->de.get_lo_ref());
}
void OpcodeHandler::opcode_84() {
  opcode_add_a(cpu->hl.get_hi_ref());
}
void OpcodeHandler::opcode_85() {
  opcode_add_a(cpu->hl.get_lo_ref());
}
void OpcodeHandler::opcode_86() {
  opcode_add_a(cpu->hl.get());
}
void OpcodeHandler::opcode_87() {
  opcode_add_a(cpu->af.get_hi_ref());
}
void OpcodeHandler::opcode_88() {
  opcode_adc(cpu->bc.get_hi_ref());
}
void OpcodeHandler::opcode_89() {
  opcode_adc(cpu->bc.get_lo_ref());
}
void OpcodeHandler::opcode_8A() {
  opcode_adc(cpu->de.get_hi_ref());
}
void OpcodeHandler::opcode_8B() {
  opcode_adc(cpu->de.get_lo_ref());
}
void OpcodeHandler::opcode_8C() {
  opcode_adc(cpu->hl.get_hi_ref());
}
void OpcodeHandler::opcode_8D() {
  opcode_adc(cpu->hl.get_lo_ref());
}
void OpcodeHandler::opcode_8E() {
  opcode_adc(cpu->hl.get());
}
void OpcodeHandler::opcode_8F() {
  opcode_adc(cpu->af.get_hi_ref());
}
void OpcodeHandler::opcode_90() {
  opcode_sub(cpu->bc.get_hi_ref());
}
void OpcodeHandler::opcode_91() {
  opcode_sub(cpu->bc.get_lo_ref());
}
void OpcodeHandler::opcode_92() {
  opcode_sub(cpu->de.get_hi_ref());
}
void OpcodeHandler::opcode_93() {
  opcode_sub(cpu->de.get_lo_ref());
}
void OpcodeHandler::opcode_94() {
  opcode_sub(cpu->hl.get_hi_ref());
}
void OpcodeHandler::opcode_95() {
  opcode_sub(cpu->hl.get_lo_ref());
}
void OpcodeHandler::opcode_96() {
  opcode_sub(cpu->hl.get());
}
void OpcodeHandler::opcode_97() {
  opcode_sub(cpu->af.get_hi_ref());
}
void OpcodeHandler::opcode_98() {
  opcode_sbc(cpu->bc.get_hi_ref());
}
void OpcodeHandler::opcode_99() {
  opcode_sbc(cpu->bc.get_lo_ref());
}
void OpcodeHandler::opcode_9A() {
  opcode_sbc(cpu->de.get_hi_ref());
}
void OpcodeHandler::opcode_9B() {
  opcode_sbc(cpu->de.get_lo_ref());
}
void OpcodeHandler::opcode_9C() {
  opcode_sbc(cpu->hl.get_hi_ref());
}
void OpcodeHandler::opcode_9D() {
  opcode_sbc(cpu->hl.get_lo_ref());
}
void OpcodeHandler::opcode_9E() {
  opcode_sbc(cpu->hl.get());
}
void OpcodeHandler::opcode_9F() {
  opcode_sbc(cpu->af.get_hi_ref());
}
void OpcodeHandler::opcode_A0() {
  opcode_and(cpu->bc.get_hi_ref());
}
void OpcodeHandler::opcode_A1() {
  opcode_and(cpu->bc.get_lo_ref());
}
void OpcodeHandler::opcode_A2() {
  opcode_and(cpu->de.get_hi_ref());
}
void OpcodeHandler::opcode_A3() {
  opcode_and(cpu->de.get_lo_ref());
}
void OpcodeHandler::opcode_A4() {
  opcode_and(cpu->hl.get_hi_ref());
}
void OpcodeHandler::opcode_A5() {
  opcode_and(cpu->hl.get_lo_ref());
}
void OpcodeHandler::opcode_A6() {
  opcode_and(cpu->hl.get());
}
void OpcodeHandler::opcode_A7() {
  opcode_and(cpu->af.get_hi_ref());
}
void OpcodeHandler::opcode_A8() {
  opcode_xor(cpu->bc.get_hi_ref());
}
void OpcodeHandler::opcode_A9() {
  opcode_xor(cpu->bc.get_lo_ref());
}
void OpcodeHandler::opcode_AA() {
  opcode_xor(cpu->de.get_hi_ref());
}
void OpcodeHandler::opcode_AB() {
  opcode_xor(cpu->de.get_lo_ref());
}
void OpcodeHandler::opcode_AC() {
  opcode_xor(cpu->hl.get_hi_ref());
}
void OpcodeHandler::opcode_AD() {
  opcode_xor(cpu->hl.get_lo_ref());
}
void OpcodeHandler::opcode_AE() {
  opcode_xor(cpu->hl.get());
}
void OpcodeHandler::opcode_AF() {
  opcode_xor(cpu->af.get_hi_ref());
}
void OpcodeHandler::opcode_B0() {
  opcode_or(cpu->bc.get_hi_ref());
}
void OpcodeHandler::opcode_B1() {
  opcode_or(cpu->bc.get_lo_ref());
}
void OpcodeHandler::opcode_B2() {
  opcode_or(cpu->de.get_hi_ref());
}
void OpcodeHandler::opcode_B3() {
  opcode_or(cpu->de.get_lo_ref());
}
void OpcodeHandler::opcode_B4() {
  opcode_or(cpu->hl.get_hi_ref());
}
void OpcodeHandler::opcode_B5() {
  opcode_or(cpu->hl.get_lo_ref());
}
void OpcodeHandler::opcode_B6() {
  opcode_or(cpu->hl.get());
}
void OpcodeHandler::opcode_B7() {
  opcode_or(cpu->af.get_hi_ref());
}
void OpcodeHandler::opcode_B8() {
  opcode_cp(cpu->bc.get_hi_ref());
}
void OpcodeHandler::opcode_B9() {
  opcode_cp(cpu->bc.get_lo_ref());
}
void OpcodeHandler::opcode_BA() {
  opcode_cp(cpu->de.get_hi_ref());
}
void OpcodeHandler::opcode_BB() {
  opcode_cp(cpu->de.get_lo_ref());
}
void OpcodeHandler::opcode_BC() {
  opcode_cp(cpu->hl.get_hi_ref());
}
void OpcodeHandler::opcode_BD() {
  opcode_cp(cpu->hl.get_lo_ref());
}
void OpcodeHandler::opcode_BE() {
  opcode_cp(cpu->hl.get());
}
void OpcodeHandler::opcode_BF() {
  opcode_cp(cpu->af.get_hi_ref());
}
...
void OpcodeHandler::opcode_E9() {
  opcode_jp(cpu->hl.get());
}
void OpcodeHandler::opcode_EA() {
  opcode_ld_to_addr(cpu->af.get_hi_ref());
}
...
void OpcodeHandler::opcode_F9() {
  opcode_ld(cpu->sp.get(), cpu->hl);
}
void OpcodeHandler::opcode_FA() {
  opcode_ld_from_addr(cpu->af.get_hi_ref());
}
